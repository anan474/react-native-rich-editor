...
* `removeColorAndBackgroundColor`
    A boolean value (false as default) that determines on removing content pasted value color and background color. Not work when pasteAsPlainText is true.
